...
```bash
# 运行自动化脚本
bash templates/.claude/skills/daily-report/resources/daily-report-automation.sh
```

### 使用Launchd定时任务
```bash
# 安装Launchd定时任务
cp templates/.claude/skills/daily-report/resources/com.user.claude-daily-report.plist ~/Library/LaunchAgents/
launchctl load ~/Library/LaunchAgents/com.user.claude-daily-report.plist
```
...
- **resources/daily-report-automation.sh**：自动化日报生成脚本
- **resources/com.user.claude-daily-report.plist**：macOS Launchd定时任务配置
